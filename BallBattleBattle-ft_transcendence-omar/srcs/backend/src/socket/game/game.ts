const width: number = 100,
  height: number = 100,
  INITIAL_VELOCITY: number = 0.5, /// before 0.04
  VELOCITY_INCREASE: number = 0.000;  // before 0.000003;
...
export default class room {
  ...
  time_start: number;
  time_end: number;
  constructor(roomId: string, Player2: boolean, admin: string, dbAdminId: string, Admin_avatar: string, Admin_fullName: string, Admin_player_state: object, Admin_tier: object) {
    this.roomId = roomId;
  ...
  set Meet_FullName(Meet_fullName) { this.Meet_fullName = Meet_fullName; }
  set Meet_Avatar(Meet_avatar) { this.Meet_avatar = Meet_avatar; }
